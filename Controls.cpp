...
void CCheckBox::Draw(bool hover)
{
	...
	if (hover)
	{
		if (Checked)
		{
			Render::GradientV(a.x + 2, a.y + 2, 9, 9, Color(150, 20, 20, 255), Color(20, 20, 20, 255));
		}
		else
		{
			Render::GradientV(a.x + 2, a.y + 2, 9, 9, Color(30, 30, 30, 200), Color(40, 40, 40, 255));
		}
		Render::GradientV(a.x + 2, a.y + 2, 9, 9, Color(150, 0, 0, 80), Color(20, 20, 20, 80));
	}
	else if (Checked)
	{
		Render::GradientV(a.x + 2, a.y + 2, 9, 9, Color(150, 20, 20, 255), Color(20, 20, 20, 255));
...
void CSlider::Draw(bool hover)
{
	...
	Render::GradientV(a.x, a.y + 4, m_iWidth, 5, Color(30, 30, 30, 255), Color(40, 40, 40, 255));
...
void CButton::Draw(bool hover)
{
	POINT a = GetAbsolutePos();
	if (hover)
		Render::GradientV(a.x + 2, a.y + 2, m_iWidth - 4, m_iHeight - 6, Color(199, 19, 19, 200), Color(20, 20, 20, 200));
	else
